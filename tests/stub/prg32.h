...
void prg32_gfx_clear(uint16_t);void prg32_gfx_present(void);void prg32_gfx_rect(int,int,int,int,uint16_t);void prg32_gfx_pixel(int,int,uint16_t);void prg32_gfx_rect_indexed(int,int,int,int,uint8_t);void prg32_gfx_pixel_indexed(int,int,uint8_t);void prg32_gfx_clear_indexed(uint8_t);void prg32_palette_set(uint8_t,uint16_t);uint32_t prg32_ticks_ms(void);void prg32_gfx_text8(int,int,const char*,uint16_t,uint16_t);
