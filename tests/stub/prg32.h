...
void prg32_gfx_clear(uint16_t);void prg32_gfx_present(void);void prg32_gfx_rect(int,int,int,int,uint16_t);void prg32_gfx_pixel(int,int,uint16_t);void prg32_gfx_text8(int,int,const char*,uint16_t,uint16_t);
